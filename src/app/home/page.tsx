        ...
        <div className="mx-auto max-w-7xl px-6 py-24 md:py-32">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="mt-6 text-lg text-gray-600 mx-auto max-w-2xl">
              Publify réunit tous vos réseaux sociaux dans une seule interface
              intuitive. Créez, planifiez et analysez votre contenu en quelques
              clics.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="text-lg text-gray-600">
              Des outils puissants pour optimiser votre présence sur les réseaux
              sociaux et gagner du temps au quotidien.
            </p>
          </div>
      ...
      <section className="bg-blue-600 text-white py-24">
        <div className="mx-auto max-w-7xl px-6 text-center">
          ...
          <p className="mt-4 text-lg text-blue-100 max-w-2xl mx-auto">
            ...
            Publify pour leur gestion des réseaux sociaux.
          </p>
          <div className="mt-10">
            <button
              onClick={handleNavigation}
